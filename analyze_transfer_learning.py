...
dataset_order = ["CIFAR10", "CIFAR100", "Caltech101", "Caltech256", "DTD", "FGVC-Aircraft", "Food101", "Flowers102", "IIITPets", "SUN397", "StanfordCars"]
    ...
    for k, dataset in enumerate(dataset_order):
        ...
        for model in checkpoint['train_losses'].keys():
            if dataset in checkpoint['train_losses'][model]:
                ...
                y_train = moving_average(y_train, 100)
